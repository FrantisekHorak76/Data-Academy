 ...
 * Tabulka avg_milk = průměrná cena mléka v letech 2006, 2018
 * Tabulka avg_bread = průměrná cena chleba v letech 2006, 2018
 * Tabulka avg_payroll = průměrný plat v letech 2006, 2018 */
...
/* Výsledná odpověď na výzkumnou otázku ohledně možného množství koupě mléka a chleba na základě průměrného platu ze všech odvětví v letech 2006, 2018*/
SELECT 
	am.year_value ,
	am.avg_price_milk ,
	ab.avg_price_bread,

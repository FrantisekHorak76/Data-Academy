/*Vytvoření pomocných tabulek pro vytvoření odpovědí na otázku č.5
 *Tabulka gdp_cze = HDP ČR ve sledovaném období (2006-2018)
 *Tabulka avg_payroll_product_gdp_comparison = zde je vidět meziroční růst, nebo pokles průměrné ceny potravin, mezd a HDP */
WITH gdp_cze AS (
	SELECT 
		`year` ,
		GDP 
...
-- Vytvoření výsledné tabulky na otázku č. 5.
SELECT 
 *,
 CASE 
